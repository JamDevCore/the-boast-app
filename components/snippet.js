...
const Snippet = ({ userId, className }) => {
  ...
  return (
    ...
    <pre>
      <code key={defaultButton}>
        &lt;script async data-userId={`"${userId}"`} data-defaultButton={`${defaultButton ? '"true"' : '""'}`} src="https://unpkg.com/boast-init/umd/boast-init.min.js"&gt;&lt;/script&gt;
      </code>
      </pre>
